...
const { Config, Catalog, Orientation, Blueprint, CraftModel, CraftHistory, State, Capabilities } = global.VAW_RUNTIME;
...
assert.strictEqual(document.selectedBlock, 'Hull');
