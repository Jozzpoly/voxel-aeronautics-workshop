...
source_files=[
 ...
 ROOT/'src/foundation/orientation.js', ROOT/'src/foundation/blueprint.js', ROOT/'src/foundation/craft_model.js', ROOT/'src/foundation/craft_history.js', ROOT/'src/foundation/state.js',
...
if 'const SAVE_VERSION = 7' not in js: errors.append('Unexpected save version')
...
for expected in [
 ...
 'foundation.blueprint', 'foundation.craft-model', 'foundation.craft-history', 'foundation.state'
]:
