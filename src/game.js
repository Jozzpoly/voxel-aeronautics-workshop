'use strict';
    ...
    const rendererProfilesModuleId = 'game.visual-renderer-profiles';
    ...
    const MobileGameCommandAdapter = window.VAW.require('game.mobile-game-command-adapter');
    ...
    MobileCommandPort.register(MobileGameCommandAdapter.create({
